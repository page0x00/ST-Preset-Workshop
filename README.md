...
当前版本基于作者 [yui-ovo/ST-Preset-Workshop](https://github.com/yui-ovo/ST-Preset-Workshop) 的 **2.98.8**（`2669ad8eb923fa8531ca2b35cfc02dd8fbc1c6e0`），二改版本 **2.98.8-page0x00.4**。
...
本版 **2.98.8-page0x00.4**：优化手机日夜／美化切换与双面板比例拖拽，减少样式计算和拖动绘制开销，保留原有功能、材质与过渡效果。由 page0x00 发布到 `mine/二改版`：[简短更新介绍](docs/release-2.98.8-page0x00.4.md)、[本轮说明与验收](docs/phone-performance-20260914.md)。
